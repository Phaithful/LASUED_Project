...
function regenerateCORS(){
	...
	if (ip == 'localhost' || ip == '::1') {
		...
		url = window.location.protocol + "//" + window.location.host + "/nnpc/";
	} else {
	...
	$.ajax({
		...
		data:{op:'dbobject.regenerateCORS', 'regenerate':true},
		success: function(data){
			// console.log(data);
			$('#nrfa-csrf-token-label').attr('value',data);
		},
		error: function(){
			console.log('failed');
		}
...
function printDiv(seldiv) {
  ...
  newWin.document.write(
    '<html><link rel="stylesheet" type="text/css" href="styles/style.css"><link rel="stylesheet" type="text/css" href="vendor/bootstrap/dist/css/bootstrap.css"></link><link rel="stylesheet" type="text/css" href="css/printcss.css"></link><body><div class="block-fluid clearfix">' +
...
function datatable_check(op, data) {
  table_select = $("#datatables").DataTable({
    ...
    ajax: {
      url: "utilities?nrfa-csrf-token-label="+$("#nrfa-csrf-token-label").val(),
      type: "POST",
      data: function (d, l) {
